...
373 条建议，每条写明花掉什么、换回什么、证据有多硬，来源只引期刊论文和官方文件。
...
[![条目](https://img.shields.io/badge/%E6%9D%A1%E7%9B%AE-373%20%E6%9D%A1-18794e?style=flat-square)](#目录)
[![证据分级](https://img.shields.io/badge/%E8%AF%81%E6%8D%AE%E5%88%86%E7%BA%A7-A%20233%20%C2%B7%20B%2092%20%C2%B7%20C%2048-915930?style=flat-square)](#证据分级)
[![原始文献](https://img.shields.io/badge/%E5%8E%9F%E5%A7%8B%E6%96%87%E7%8C%AE-717%20%E6%9D%A1%E9%93%BE%E6%8E%A5-565a5f?style=flat-square)](docs/核实记录/)
[![许可](https://img.shields.io/badge/%E8%AE%B8%E5%8F%AF-Unlicense-565a5f?style=flat-square)](LICENSE)

**[打开在线检索页](https://eternity4719.github.io/HowToLiveBetter/)** · [目录](#目录) · [术语表](#读懂数字术语表) · [核实记录](docs/核实记录/) · [结婚划不划算（长文）](docs/结婚划不划算.md) · [家庭应急装备清单（长文）](docs/家庭应急装备清单.md) · [做平台要办哪些证（长文）](docs/做平台要办哪些证.md)
...
| 做个网站或平台收钱，要办哪些证、服务器放哪？ | [26. 做一个网站或平台](#26-做一个网站或平台资质备案和服务器) |
...
- **只想看结论最硬的**：在检索页里勾选证据等级 A，只留下有具体数字、来自荟萃分析或大型试验的 233 条。
- **只想看最值得做的**：勾选性价比「极高」，得到 66 条既不花钱、不花时间、不需要毅力，收益又落在最大一档的条目。再叠加一个「换回什么」，就是该口径下的优先清单。
...
全书 373 条中 A 级 233 条、B 级 92 条、C 级 48 条，另有 42 条标注了争议、37 处标注了 TODO 待核实。有争议的 A/B 级条目会标注「争议」并列出反方证据。所有来源只引原始文献（期刊论文附 DOI 或 PubMed 链接，或 WHO/CDC/国家统计局等官方机构报告），不引二手转述。不确定的数字标「待核实」。
...
全书 373 条中性价比极高 66 条（18%）、高 183 条（49%）、一般 124 条（33%）。中间一档偏厚是有意的：底层的收益量级只有三级判断，再往下切就是假装精度。
...
1. [不要早死](#1-不要早死)：外因死亡、燃气与中毒、疫苗、筛查、心理危机、家庭应急装备。口径：总死亡率 或特定死因。
...
8. [别把自己搭进去：法律与财产安全](#8-别把自己搭进去法律与财产安全)：交通事故、被骗止付、被指控、彩礼、婚前财产、担保、反诈、被执行与失信名单、养犬责任。口径：金钱/人身自由。
9. [普通人容易踩的法律红线](#9-普通人容易踩的法律红线)：谣言、侮辱英烈、传播色情、兼职洗钱、伪造材料骗贷、高空抛物、仿真枪、无人机、偷拍、赌博、野味。口径：人身自由/金钱。
...
12. [创业与做生意：别把家底赔进去](#12-创业与做生意别把家底赔进去)：本钱、担保、主体选择、注册登记、许可证、纳税申报、发票、涉税诈骗、合同、用人、量产、退场。口径：金钱/法律责任。
...
22. [怎么放松：娱乐场所和减压](#22-怎么放松娱乐场所和减压)：安全出口、明码标价、涉毒红线、别人递的东西、网吧实名、剧本杀选址；运动、正念、呼吸、社交、绿地。口径：金钱/人身自由，以及精力/总死亡率。
...
26. [做一个网站或平台：资质、备案和服务器](#26-做一个网站或平台资质备案和服务器)：支付结算红线、ICP 许可与备案、直播与视听资质、平台核验与涉税报送、内容治理、实名、未成年人、通知删除、数据出境、服务器选型。口径：人身自由/金钱。长文见 [docs/做平台要办哪些证.md](docs/做平台要办哪些证.md)。

每节内条目按性价比从高到低排列。「不要早死」「不要浪费时间」这类节标题说的是这一节想防住的结果，条目本身要做还是别做，以条目标题为准。长文另见 [docs/家庭应急装备清单.md](docs/家庭应急装备清单.md)、[docs/做平台要办哪些证.md](docs/做平台要办哪些证.md) 和 [docs/结婚划不划算.md](docs/结婚划不划算.md)。每条来源的核实过程记录在 [docs/核实记录](docs/核实记录/)。
...
- 备注：争议。同一份 Cochrane 里不发装备的干预 IRR 0.78（95% CI 0.66 到 0.92），发装备的组并没有做得更好，降低伤害的主要是入户教育和改造，所以装备的收益记「中」不记「大」。买灭火器认准 CCC 标志，贮压式的指针要停在绿区。烟雾报警器和一氧化碳报警器见本节第 3 条，止血带的用法见第 13 节第 4 条，逐项怎么选、放哪里、几年换见 [docs/家庭应急装备清单.md](docs/家庭应急装备清单.md)
...
### 12. 在医保 App 上办一次家庭共济绑定，职工医保个人账户的钱就能给配偶、父母、子女看病买药
<!-- 成本标签: 钱=0 时间=少 毅力=否 收益=中 口径=金钱 -->
...
### 24. 三者险买够：交强险限额全国统一且不高，超出的部分从你自己家里出
...
### 28. 直播间买的东西出了问题，先向平台要卖家和带货人的信息，平台必须给
<!-- 成本标签: 钱=0 时间=少 毅力=否 收益=中 口径=金钱 -->
- 成本：0 元；向平台提出要求即可
...
### 5. 有人拉你去「包装材料」贷款、按贷款额分你好处费，一个都不做
<!-- 成本标签: 钱=0 时间=少 毅力=否 收益=大 口径=自由 -->
...
- 备注：「我当时是想还的」在那个案子里没被采纳：检察机关查明这些人无工作、无固定资产，根本无力还款，分成又都花掉了，据此认定有非法占有目的；替团伙把钱取出来，还可能另外构成洗钱罪。钱贷在谁名下、合同谁签的字，谁就是借款人，就算不构成犯罪，债和征信记录也是自己的。拿了钱跑到境外一样不了结：立案侦查后逃避侦查或者审判的不受追诉期限限制；被判处刑罚尚未执行完毕、身为犯罪嫌疑人或被告人的不准出境，有未了结的民事案件法院可以决定不准出境，被执行人不履行的法院可以采取或者通知有关单位协助采取限制出境。替人取现转账见本节第 4 条，被冒名贷款怎么发现见第 8 节第 7 条。

### 6. 捡到银行卡不取钱，捡到手机、钱包联系失主或交给警察，不揣走
<!-- 成本标签: 钱=0 时间=少 毅力=否 收益=大 口径=自由 -->
- 成本：0 元；打个电话或送到派出所
...
### 9. 买了无人机先实名登记，机场、军事区和城市管制空域不飞，不破解限高
...
### 11. 麻将、扑克可以打，不抽头、不当庄、不组局收钱，不玩网络赌博
<!-- 成本标签: 钱=0 时间=少 毅力=些 收益=大 口径=自由 -->
...
### 14. 身份证不借人，不用别人的身份证，也不拿别人的证件登记、开卡、买票
<!-- 成本标签: 钱=0 时间=少 毅力=否 收益=大 口径=自由 -->
...
### 15. 被警察拦下或带走时配合，不推、不打、不抢执法记录仪，喝了酒更要忍
<!-- 成本标签: 钱=0 时间=少 毅力=些 收益=大 口径=自由 -->
...
- 备注：这条不只在娱乐场所：学校门口、朋友聚会、长途车上同理，给的是糖果、饮料还是烟弹都一样。被下药之后常跟着抢劫、性侵和敲诈，那部分没有公开的官方统计，属经验判断。饮料只要离开过视线就换一杯，比事后追究省事得多。场子里有人拿出不明粉末、片剂、烟弹的处置见本节第 3 条；替人带东西见第 8 节第 21 条。
