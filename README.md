...
392 条建议，每条写明花掉什么、换回什么、证据有多硬，来源只引期刊论文和官方文件。
...
[![条目](https://img.shields.io/badge/%E6%9D%A1%E7%9B%AE-392%20%E6%9D%A1-18794e?style=flat-square)](#目录)
[![证据分级](https://img.shields.io/badge/%E8%AF%81%E6%8D%AE%E5%88%86%E7%BA%A7-A%20248%20%C2%B7%20B%2096%20%C2%B7%20C%2048-915930?style=flat-square)](#证据分级)
[![原始文献](https://img.shields.io/badge/%E5%8E%9F%E5%A7%8B%E6%96%87%E7%8C%AE-758%20%E6%9D%A1%E9%93%BE%E6%8E%A5-565a5f?style=flat-square)](docs/核实记录/)
...
- **只想看最值得做的**：勾选性价比「极高」，得到 69 条既不花钱、不花时间、不需要毅力，收益又落在最大一档的条目。再叠加一个「换回什么」，就是该口径下的优先清单。
...
全书 392 条中 A 级 248 条、B 级 96 条、C 级 48 条，另有 42 条标注了争议、36 处标注了 TODO 待核实。有争议的 A/B 级条目会标注「争议」并列出反方证据。所有来源只引原始文献（期刊论文附 DOI 或 PubMed 链接，或 WHO/CDC/国家统计局等官方机构报告），不引二手转述。不确定的数字标「待核实」。
...
全书 392 条中性价比极高 69 条（18%）、高 196 条（50%）、一般 127 条（32%）。中间一档偏厚是有意的：底层的收益量级只有三级判断，再往下切就是假装精度。
...
8. [别把自己搭进去：法律与财产安全](book/08-别把自己搭进去.md)：交通事故、被骗止付、AI 换脸拟声、被指控、彩礼、婚前财产、担保、反诈、诉讼时效、被执行与失信名单、养犬责任。口径：金钱/人身自由。
...
13. [紧急情况：先做什么](book/13-紧急情况.md)：心脏骤停、大出血、咬伤、烧烫伤、过敏性休克、癫痫、低血糖、触电、一氧化碳、误服与化学品、骗局、隐私威胁、中暑、火灾、溺水、迷路、失温、蛇咬、地震、野兽、雷击、高原病、蜱虫、野外饮水。口径：存活率与金钱。
...
19. [被裁员、离职和工伤](book/19-被裁员离职和工伤.md)：加班费、年休假、试用期；N、代通知金、2N、别签主动辞职、留证；工伤认定时限、单位未参保、劳动能力鉴定、工亡待遇。口径：金钱。
...
24. [看病：怎么少花钱少走弯路](book/24-看病.md)：分级诊疗与转诊、起付线连续计算、报销比例差、预留号源、异地就医必要性评估、病历留存与封存。口径：金钱/时间。
