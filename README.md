...
408 条建议，每条写明花掉什么、换回什么、证据有多硬，来源只引期刊论文和官方文件。
...
[![条目](https://img.shields.io/badge/%E6%9D%A1%E7%9B%AE-408%20%E6%9D%A1-18794e?style=flat-square)](#目录)
...
- **只想看结论最硬的**：在检索页里勾选证据等级 A，只留下有具体数字、来自荟萃分析或大型试验的 255 条。
- **只想看最值得做的**：勾选性价比「极高」，得到 72 条既不花钱、不花时间、不需要毅力，收益又落在最大一档的条目。再叠加一个「换回什么」，就是该口径下的优先清单。
...
全书 408 条中 A 级 255 条、B 级 105 条、C 级 48 条，另有 42 条标注了争议、36 处标注了 TODO 待核实。有争议的 A/B 级条目会标注「争议」并列出反方证据。所有来源只引原始文献（期刊论文附 DOI 或 PubMed 链接，或 WHO/CDC/国家统计局等官方机构报告），不引二手转述。不确定的数字标「待核实」。
...
全书 408 条中性价比极高 72 条（18%）、高 206 条（50%）、一般 130 条（32%）。中间一档偏厚是有意的：底层的收益量级只有三级判断，再往下切就是假装精度。
...
13. [紧急情况：先做什么](book/13-紧急情况.md)：心脏骤停、卒中与后循环卒中、眼中风、心梗、主动脉夹层、霹雳样头痛、慢性硬膜下血肿、肺栓塞、大出血、咬伤、烧烫伤、过敏性休克、癫痫、低血糖、触电、一氧化碳、误服与化学品灼伤、骗局、隐私威胁、中暑、火灾、溺水、迷路、失温、蛇咬、地震、野兽、雷击、高原病、蜱虫、野外饮水。口径：存活率与金钱。
