...
每节内条目按性价比从高到低排列。长文另见 [docs/家庭应急装备清单.md](docs/家庭应急装备清单.md)、[docs/做平台要办哪些证.md](docs/做平台要办哪些证.md) 和 [docs/结婚划不划算.md](docs/结婚划不划算.md)。每条来源的核实过程记录在 [docs/核实记录](docs/核实记录/)。
