...
203 条建议，每条写明花掉什么、换回什么、证据有多硬，来源只引期刊论文和官方文件。
...
[![条目](https://img.shields.io/badge/%E6%9D%A1%E7%9B%AE-203%20%E6%9D%A1-18794e?style=flat-square)](#目录)
[![证据分级](https://img.shields.io/badge/%E8%AF%81%E6%8D%AE%E5%88%86%E7%BA%A7-A%20113%20%C2%B7%20B%2066%20%C2%B7%20C%2024-915930?style=flat-square)](#证据分级)
[![原始文献](https://img.shields.io/badge/%E5%8E%9F%E5%A7%8B%E6%96%87%E7%8C%AE-477%20%E6%9D%A1%E9%93%BE%E6%8E%A5-565a5f?style=flat-square)](docs/核实记录/)
...
| 结婚到底划不划算，怎么算这笔账？ | [10. 结婚划不划算](#10-结婚划不划算) |
...
- **只想看结论最硬的**：在检索页里勾选证据等级 A，只留下有具体数字、来自荟萃分析或大型试验的 113 条。
...
全书 203 条中 A 级 113 条、B 级 66 条、C 级 24 条，另有 22 条标注了争议、26 处标注了待核实。有争议的 A/B 级条目会标注「争议」并列出反方证据。所有来源只引原始文献（期刊论文附 DOI 或 PubMed 链接，或 WHO/CDC/国家统计局等官方机构报告），不引二手转述。不确定的数字标「待核实」。
...
1. [不要早死](#1-不要早死)：外因死亡、疫苗、筛查、心理危机。口径：总死亡率 或特定死因。
...
8. [别把自己搭进去：法律与财产安全](#8-别把自己搭进去法律与财产安全)：交通事故、被骗止付、被指控、彩礼、婚前财产、担保、反诈。口径：金钱/人身自由。
9. [普通人容易踩的法律红线](#9-普通人容易踩的法律红线)：谣言、侮辱英烈、传播色情、兼职洗钱、高空抛物、仿真枪、无人机、偷拍、赌博、野味。口径：人身自由/金钱。
10. [结婚划不划算](#10-结婚划不划算)：登记数据、健康账、时间账、钱账、关系质量、退出成本。长文见 [docs/结婚划不划算.md](docs/结婚划不划算.md)。
...
### 15. 大额非必需购买设 24 小时冷静期，网购善用七日无理由退货
<!-- 成本标签: 钱=0 时间=少 毅力=些 -->
- 成本：延后一天满足；退货运费通常自付
...
### 18. 先存出 3 到 6 个月生活费的应急金，放在随时能取的地方
<!-- 成本标签: 钱=0 时间=少 毅力=些 -->
...
### 9. 得了重病先走医保、大病保险、医疗救助和异地备案，不碰网贷
<!-- 成本标签: 钱=0 时间=中 毅力=些 -->
...
### 11. 办失业登记后争取就业困难人员认定，拿社保补贴或公益性岗位
<!-- 成本标签: 钱=0 时间=中 毅力=些 -->
...
### 13. 不交押金、不押证件、不签「培训贷」、不进传销、不借高利贷
<!-- 成本标签: 钱=0 时间=少 毅力=些 -->
...
### 15. 把住和吃压到最低：合租月租代替日租，自炊和助餐食堂代替外卖
<!-- 成本标签: 钱=0 时间=中 毅力=些 -->
...
### 17. 坐过牢、破过产、上过失信名单，法律上都有重来的路，先把手续走完
<!-- 成本标签: 钱=0 时间=中 毅力=是 -->
...
### 18. 大病之前，基本医保之外配一份一年期医疗险或重疾险，看清「保证续保」四个字
<!-- 成本标签: 钱=少 时间=少 毅力=否 -->
...
### 19. 实在没地方睡，24 小时营业场所只能应急一晚，优先去救助站
<!-- 成本标签: 钱=少 时间=少 毅力=些 -->
...
### 8. 网上不骂人、不造谣、不转发没核实的事；被网暴先留证再报警
<!-- 成本标签: 钱=0 时间=少 毅力=些 -->
...
### 11. 网购、二手交易被骗，先平台投诉，再报警，再算值不值得起诉
<!-- 成本标签: 钱=少 时间=中 毅力=些 -->
...
### 12. 恋爱和婚内的大额赠与，交付之前想清楚，交付之后原则上要不回
<!-- 成本标签: 钱=0 时间=少 毅力=些 -->
...
### 15. 结婚前核对对方婚姻状况，以结婚为幌子骗钱的按诈骗罪追究
<!-- 成本标签: 钱=0 时间=少 毅力=否 -->
...
### 6. 算退出成本：协议离婚有 30 天冷静期，诉讼离婚有法定条件
<!-- 成本标签: 钱=0 时间=中 毅力=些 -->
...
### 13. 地震时先看自己在什么房子里：平房或一层几步能出门就到空地去，楼上就地躲、摇完再走
<!-- 成本标签: 钱=0 时间=少 毅力=否 -->
- 成本：0 元；提前看一眼自己家出门要几步、走哪条路、哪张桌子结实
- 收益：亚美尼亚 1988 年地震（苏联式预制板楼成片垮塌）的病例对照研究，189 名住院伤者对 159 名同社区未受伤者：「第一下震动之后离开建筑是保护性行为」，待在室内相对跑出去的受伤比值比 4.40（95% CI 2.24–8.71）；地震时在建筑内相对在室外为 12.20（3.62–63.79）；在 5 层以上建筑内相对更矮建筑为 3.65（2.12–6.33）。美国 FEMA 对本国住宅给的是相反建议：「就地趴下」「用一只手臂护住头颈」「抓牢直到摇晃停止」「在室内就待着，不要往外跑，避开门框」
- 证据等级：B
- 来源：Armenian HK, Noji EK, Oganesian AP (1992). A case-control study of injuries arising from the earthquake in Armenia, 1988. Bulletin of the World Health Organization, 70(2), 251-257. <https://europepmc.org/article/MED/1600585>；US FEMA Ready.gov. Earthquakes. <https://www.ready.gov/earthquakes>；Mahue-Giangreco M, Mack W, Seligson H, Bourque LB (2001). Risk factors associated with moderate and serious injuries attributable to the 1994 Northridge Earthquake. Annals of Epidemiology, 11(5), 347-357. <https://doi.org/10.1016/s1047-2797(01)00220-4>
- 备注：争议，两种建议针对的是两种房子。亚美尼亚那批楼整栋垮塌，人在里面躲无处可躲，出去才占优；美国的建议针对抗震设防、极少整栋垮的住宅，那里的伤主要来自坠物和摇晃中移动摔倒，Northridge 的研究还提示伸手去接东西、扶住「看起来稳」的东西会加重受伤。所以判断的不是「跑不跑」，是「这栋楼会不会垮、你几秒内能不能到空地」：平房、一层、老旧砖房和无抗震设防的自建房，门就在几步外，出去；要下楼梯、穿门厅、走玻璃幕墙下面的，就地躲。亚美尼亚这项研究只比了幸存者中的受伤与未受伤，没纳入遇难者，也没说明是否校正楼层，能跑出去的人本身可能就在低层，数字要打折看。任何情况下都不跳楼、不坐电梯、不在摇晃中下楼梯，出去后离开建筑、树、路灯和电线。中国地震局科普页正文为脚本渲染，未能提取文字，TODO（待核实：中国地震局原文）。
